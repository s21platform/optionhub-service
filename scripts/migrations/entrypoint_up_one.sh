...
goose -dir ./migrations postgres "user=$OPTIONHUB_POSTGRES_USER password=$OPTIONHUB_POSTGRES_PASSWORD dbname=$OPTIONHUB_POSTGRES_DB host=$OPTIONHUB_POSTGRES_HOST port=$OPTIONHUB_POSTGRES_PORT sslmode=disable" up 1